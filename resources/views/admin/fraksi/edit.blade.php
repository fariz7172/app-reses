...
<div class="content-card">
    <div class="content-card-header">
        <h2 class="content-card-title">Edit Data Fraksi</h2>
    ...
    <div style="padding: 24px;">
        ...
        <form action="{{ route('admin.fraksi.update', $fraksi->id) }}" method="POST">
            @csrf
            @method('PUT')
            ...
            <div style="margin-bottom: 20px; max-width: 500px;">
                ...
                <input type="text" name="nama_fraksi" required value="{{ old('nama_fraksi', $fraksi->nama_fraksi) }}" style="width: 100%; padding: 10px; border: 1px solid #d1d5db; border-radius: 8px;">
            </div>
