...
<div class="content-card">
    <div class="content-card-header">
        <h2 class="content-card-title">Tambah Data Vendor</h2>
    ...
    <div style="padding: 24px;">
        ...
        <form action="{{ route('admin.vendor.store') }}" method="POST">
            ...
            <div style="margin-bottom: 20px; max-width: 500px;">
                ...
                <input type="text" name="nama" required value="{{ old('nama') }}" placeholder="Contoh: PT. Bangun Persada..." style="width: 100%; padding: 10px; border: 1px solid #d1d5db; border-radius: 8px;">
            </div>
