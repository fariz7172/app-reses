...
<div class="content-card">
    <div class="content-card-header">
        <h2 class="content-card-title">Tambah Data Pelaksana</h2>
    ...
    <div style="padding: 24px;">
        ...
        <form action="{{ route('admin.pelaksana.store') }}" method="POST">
            @csrf
            ...
            <div style="margin-bottom: 20px; max-width: 500px;">
                ...
                <input type="text" name="nama" required value="{{ old('nama') }}" style="width: 100%; padding: 10px; border: 1px solid #d1d5db; border-radius: 8px;">
            </div>

            <div style="margin-bottom: 20px; max-width: 500px;">
                <label style="display: block; font-size: 13px; font-weight: 600; color: #374151; margin-bottom: 6px;">NIP</label>
                <input type="text" name="nip" value="{{ old('nip') }}" style="width: 100%; padding: 10px; border: 1px solid #d1d5db; border-radius: 8px;">
            </div>

            <div style="margin-bottom: 20px; max-width: 500px;">
                <label style="display: block; font-size: 13px; font-weight: 600; color: #374151; margin-bottom: 6px;">Jabatan</label>
                <input type="text" name="jabatan" value="{{ old('jabatan') }}" style="width: 100%; padding: 10px; border: 1px solid #d1d5db; border-radius: 8px;">
            </div>
            ...
            <div style="margin-top: 30px; padding-top: 20px; border-top: 1px solid #e5e7eb; max-width: 500px; display: flex; justify-content: flex-end;">
                <button type="submit" class="btn btn-primary" style="padding: 10px 24px;">Simpan Data</button>
            </div>
        </form>
    </div>
</div>
