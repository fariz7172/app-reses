...
<div class="content-card">
    <div class="content-card-header" style="display: flex; justify-content: space-between; align-items: center;">
        <h2 class="content-card-title">Data Master Pelaksana</h2>
        <a href="{{ route('admin.pelaksana.create') }}" class="btn btn-primary" style="padding: 8px 16px; font-size: 14px;">
        ...
        <table style="width: 100%; border-collapse: collapse; text-align: left; font-size: 14px;">
            <thead>
                <tr style="background: #f9fafb; border-bottom: 2px solid #e5e7eb;">
                    ...
                    <th style="padding: 12px; color: #4b5563; font-weight: 600;">Nama</th>
                    <th style="padding: 12px; color: #4b5563; font-weight: 600;">NIP</th>
                    <th style="padding: 12px; color: #4b5563; font-weight: 600;">Jabatan</th>
                    <th style="padding: 12px; color: #4b5563; font-weight: 600; width: 150px; text-align: center;">Aksi</th>
                </tr>
            </thead>
            <tbody>
                @forelse($pelaksana as $index => $item)
                ...
                @empty
                <tr>
                    <td colspan="5" style="padding: 24px; text-align: center; color: #6b7280;">Belum ada data Pelaksana.</td>
                </tr>
                @endforelse
            </tbody>
        </table>
